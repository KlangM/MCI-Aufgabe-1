...
class Test:
    ...
    def create_summary(self):
        ...
        print("Variance HR was: " + str(self.hr_variance))
    ...
    def save_data(self):
        ...
        """
        __data = {"User ID": self.subject_id, "Reason for test termation": self.manual_termination, "Average Heart Rate": self.average_hr_test, "Maximum Heart Rate": self.maximum_hr, "Test Length (s)": self.power_data.duration_s, "Test Power (W)": self.subject.test_power_w,"Variance Heart Rate": self.hr_variance,"Average Heart Rate": self.average_hr_test}
...
for test in list_of_new_tests:                      # Alle Tests werden nacheinander durchlaufen
    ...
    test.add_power_data(list_of_power_data[iterator])   #Powerdaten einlesen
    test.create_plot()                                  #PLot erstellen
    test.evaluate_termination()                         #Auf Abbruchkriterien überprüfen
    test.ask_for_termination()                          #Manueller Abbruch
