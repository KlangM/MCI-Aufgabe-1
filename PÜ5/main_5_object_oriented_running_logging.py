...
class Test:
    ...
    def create_plot(self):
        ...
        self.plot_data.plot(xlabel = "t/$s$" , ylabel = "Heartrate and Power" , title = f"Plot of Subject {str(self.subject.subject_id)}")
